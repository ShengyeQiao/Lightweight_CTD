...
class SAP(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        # res50
        #  self.conv_1 = conv1x1(in_channel, in_channel//4)
...
class CTDNet(nn.Module):
    def __init__(self, cfg):
        ...
        # res50
        # block = Bottleneck
        # self.bkbone = ResNet(block, [3, 4, 6, 3])
        ...
        self.path1_2 = SAP(512 * block.expansion, 64)
        self.path1_3 = SAP(256 * block.expansion, 64)
    ...
    def forward(self, x, shape=None):
        ...
        path1_3 = self.path1_3(l4)                                            # 1/16
        path1 = self.fuse1_2(path1_2, path1_3)                                                      # 1/16

        path2_1 = self.path2(l3)                                                # 1/8
        # path2_2 = F.interpolate(path1_2, size=l3.size()[2:], mode='bilinear', align_corners=True)
        # path2 = self.fuse12_1(path2_1, path2_2)
        path12 = self.fuse12(path1, path2_1)                                                          # 1/8
